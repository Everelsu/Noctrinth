...
export type AppEvent =
	...
	| { type: 'instance'; payload: InstancePayload }
	| { type: 'instance_groups_changed'; payload: InstanceGroupsChangedPayload }
	| { type: 'onboarding_checklist'; payload: OnboardingChecklist }
	| { type: 'instance_bulk_update_progress'; payload: InstanceBulkUpdateProgressPayload }
	| { type: 'install_job'; payload: InstallJobSnapshot }
	| { type: 'command'; payload: CommandPayload }
	| { type: 'warning'; payload: WarningPayload }
	| { type: 'friend'; payload: FriendPayload }
	| { type: 'notification'; payload: unknown }
	| { type: 'log'; payload: LogPayload }
	| { type: 'ads_consent_required'; payload: boolean }
