...
#[tauri::command]
pub async fn instance_compute_cf_fingerprints(
    instance_id: &str,
) -> Result<Vec<(String, u32)>> {
    Ok(theseus::instance::compute_cf_fingerprints(instance_id).await?)
}

#[tauri::command]
pub async fn instance_add_project_from_curseforge(
    instance_id: &str,
